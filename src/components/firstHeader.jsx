        ...
        <div className="firstHeader" >
            ...
            <div className='hoverDropdown'>
                <div className='dropdown'>
                    <button className='dropbtn' aria-label="Dropdown menu">USD <i className='fa fa-caret-down'></i></button>
                    <div className='dropdown-content'>
                        <a href='#' onClick={handleDropBtnValue4} aria-label='Currency'>
                            <i className='fa fa-usd'></i>
                            USD
                        </a>
                        <a href='#' onClick={handleDropBtnValue1} aria-label='Currency'>
                            <i className='fa fa-eur'></i>
                            EUR
                        </a>
                        <a href='#' onClick={handleDropBtnValue2} aria-label='Currency'>
                            <i className='fa fa-gbp'></i>
                            GBP</a>
                        <a href='#' onClick={handleDropBtnValue3} aria-label='Currency'>
                            <i className='fa fa-usd'></i>
                            AUD</a>
                    </div>
                </div>
