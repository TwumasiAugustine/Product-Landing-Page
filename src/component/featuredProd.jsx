                ...
                <div className='container'>
                    <div className='product-box'>
                        <div className='img-container'>
                            <img src={`./images/${productsData[0].image}`} alt={productsData[0].productName} loading="lazy"/>
                        </div>
                        <div className='product-info'>
                            ...
                            <div className='price-con'>
                                <span className='price'>$ {productsData[0].price}</span>
                            ...
                            <div className='btn-container'>
                                <button type='button' className='btn' aria-label='Buy now'>Buy Now</button>
                            </div>
                        </div>    
                    </div>
                </div>
